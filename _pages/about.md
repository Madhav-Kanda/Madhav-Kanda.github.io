...
I am currently working with [Prof. Sasa Misailovic](https://misailo.cs.illinois.edu/) on enhancing semantic accuracy in LLM-generated code through grammar-guided generation. I am also collaborating with [Prof. Heng Ji](https://blender.cs.illinois.edu/hengji.html) and [Prof. Unnat Jain](https://unnat.github.io/) on designing a multi-agent framework for complex VQA tasks—we recently submitted this work to ACL'25!
